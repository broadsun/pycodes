...
file_in = r"result2.txt"
file_out = r"result2.xls"
...
def sortData(file_in):
	...
	excel2 = xlwt.Workbook(encoding='utf-8', style_compression=0)
	sheet = excel2.add_sheet("sheet1", cell_overwrite_ok=True)
	sheet.write(0,0,'性别')
	sheet.write(0,1,'领域')
	sheet.write(0,2,'曝光数')
	sheet.write(0,3,'点击数')
